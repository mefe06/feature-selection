...
logging.basicConfig(filename='results.log', filemode ='w', level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')
...
logging.info("For M4 hourly, LGBM base, all feature MSE: {}, GBMO MSE: {}".format(np.mean(all_scores), np.mean(mo_scores)))
...
for i in range(100):
    ...
    all_scores.append(all_score)
    mo_scores.append(mo_score)
logging.info("For M4 hourly MLP base, all feature MSE: {}, GBMO MSE: {}".format(np.mean(all_scores), np.mean(mo_scores)))
...
for i in range(100):
    ...
    all_scores.append(all_score)
    mo_scores.append(mo_score)
logging.info("For M4 quarterly, LGBM base, all feature MSE: {}, GBMO MSE: {}".format(np.mean(all_scores), np.mean(mo_scores)))
...
for i in range(100):
    ...
    all_scores.append(all_score)
    mo_scores.append(mo_score)
logging.info("For M4 quarterly MLP base, all feature MSE: {}, GBMO MSE: {}".format(np.mean(all_scores), np.mean(mo_scores)))
